...
namespace DiagramEditor.ViewModels {
	...
	public class MainWindowViewModel: ViewModelBase {
		...
		private void Import(object entity) {
			if (entity is not Dictionary<string, object> @dict) { Log.Write("General: " + entity.GetType().Name + " - не словарь"); return; }

			@dict.TryGetValue("name", out var value);
			name = value is not string @str ? "Name" : @str;
		...
		public string ApplyText { get => editable is null ? "Добавить" : "Отредактировать"; }
